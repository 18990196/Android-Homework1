...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_registerphone.addTextChangedListener(new com.example.myapp.RegisterActivity.HideTextWatcher(et_registerphone));
        // 给et_registerpassword添加文本变更监听器
        et_registerpassword.addTextChangedListener(new com.example.myapp.RegisterActivity.HideTextWatcher(et_registerpassword));
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (myStr.length() == 11 && myMaxLength == 11) {
                ViewUtil.hideAllInputMethod(com.example.myapp.RegisterActivity.this);
            }
            // 输入文本达到6位（如登录密码）时关闭输入法
            if (myStr.length() == 8 && myMaxLength == 8) {
                ViewUtil.hideOneInputMethod(com.example.myapp.RegisterActivity.this, myView);
            }
