...
import com.example.myapp.bean.PhoneInfo;
...
public class ShoppingCartActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    private Runnable mPopupMenu = new Runnable() {
        ...
        public void run() {
            ...
            // 构建购物车商品列表的适配器对象
            CartAdapter adapter = new CartAdapter(com.example.myapp.ShoppingCartActivity.this, mCartArray);
            // 给lv_cart设置商品列表适配器
            lv_cart.setAdapter(adapter);
            // 重新设置lv_cart的点击监听器
            lv_cart.setOnItemClickListener(com.example.myapp.ShoppingCartActivity.this);
            // 重新设置lv_cart的长按监听器
            lv_cart.setOnItemLongClickListener(com.example.myapp.ShoppingCartActivity.this);
        }
    };
    ...
    private void goDetail(long rowid) {
        Intent intent = new Intent(this, com.example.myapp.ShoppingDetailActivity.class);
