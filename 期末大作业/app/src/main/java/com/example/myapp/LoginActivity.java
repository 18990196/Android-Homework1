...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990196-张海波"};
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if ((mStr.length() == 11 && mMaxLength == 11) || (mStr.length() == 6 && mMaxLength == 6)
                ...
                ViewUtil.hideOneInputMethod(com.example.myapp.LoginActivity.this, mView);
            }
        }
    }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.bt_forget) { // 点击了“忘记密码”按钮
            ...
            if (rb_password.isChecked()) { // 选择了密码方式校验，此时要跳到找回密码页面
                Intent intent = new Intent(this, com.example.myapp.LoginForgetActivity.class);
                // 携带手机号码跳转到找回密码页面
        ...
        if (v.getId() == R.id.bt_register) {
            Intent intent = new Intent(this, com.example.myapp.RegisterActivity.class);
